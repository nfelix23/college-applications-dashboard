...
- This page contains the methodology and recommendations for the dashboard. You don't have to read this to understand the dashboard, so feel free to explore the other pages first.
...
---"""
    ...
    with st.expander("View Methodology and Recommendations", expanded = False):
        # Methodology
        st.markdown(
"""## Methodology
